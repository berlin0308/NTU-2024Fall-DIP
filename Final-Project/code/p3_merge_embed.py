...
def get_placeholder_loop(placeholder_string, embedder, is_sd):
    ...
    print(f"Old Placeholder: {placeholder_string}")
    new_placeholder = input("New Placeholder:")
    
    return new_placeholder, get_token(embedder, new_placeholder, is_sd)


def get_token(embedder, placeholder_string, is_sd):
    if is_sd:
        return get_clip_token_for_string(embedder.tokenizer, placeholder_string)
    return get_bert_token_for_string(embedder.tknz_fn, placeholder_string)
...
"""                
python p3_merge_embed.py --manager_ckpts logs/02024-10-31T19-10-02_og-txt-inv_new1/checkpoints/embeddings_gs-3999.pt logs/12024-11-03T21-10-39_og-txt-inv_new2_david/checkpoints/embeddings_gs-6099.pt  --output_path p3_merged_3099_6099_embeds.pt --stable_diffusion

Managers merged. Final list of placeholders: 
{'*': 'logs/02024-11-03T23-52-46_og-txt-inv_corgi/checkpoints/embeddings_gs-6099.pt', '#': 'logs/12024-11-03T21-10-39_og-txt-inv_new2_david/checkpoints/embeddings_gs-6099.pt'}
"""
